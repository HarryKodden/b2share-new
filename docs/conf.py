...
html_theme_options = {
    ...
    'extra_nav_links': {
        'b2share@GitHub': 'https://github.com/EUDAT-B2SHARE/b2share',
        'b2share@PyPI': 'https://pypi.python.org/pypi/b2share/',
    }
}
...
htmlhelp_basename = 'b2share_namedoc'
...
latex_documents = [
    (master_doc, 'b2share.tex', u'b2share Documentation',
     u'EUDAT', 'manual'),
]
